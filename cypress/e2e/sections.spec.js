				...
				.then(() => {
					cy.getContent()
						...
						.should(($anchor) => {
							...
							expect($anchor.eq(0)).to.have.attr('href').and.equal('#heading-heading')
							expect($anchor.eq(1)).to.have.attr('href').and.equal('#heading-heading-2')
							expect($anchor.eq(2)).to.have.attr('href').and.equal('#heading-heading-2--1')
						})
				})
		})
