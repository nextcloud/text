		...
		cy.get('#app-sidebar-vue a.sharing-entry__copy')
			...
			.then((href) => {
				...
				cy.window().then(win => {
					...
					cy.get('#editor .ProseMirror').should('contain', 'Hello world')
					cy.get('#editor .ProseMirror h2').should('contain', 'Hello world')
					cy.get('#editor .menubar .menubar-icons .icon-undo').should('exist')
					cy.get('#editor .menubar .menubar-icons .icon-redo').should('exist')
					cy.get('#editor .menubar .menubar-icons .icon-bold').should('exist')
				})
			})
	})
