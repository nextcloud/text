OC.L10N.register(
    ...
    "Show color annotations" : "顯示色彩標示",
    "Color annotations will only show during editing sessions, they are not persisted after closing the document." : "色彩標示僅於編即時顯示，在關閉文件後將不會保留。",
