OC.L10N.register(
    ...
    "Keep my local changes and overwrite the remote version" : "Mijn lokale wijzigingen behouden en de externe versie overschrijven",
    "Discard my local changes and use the remote version" : "Mijn lokale wijzigingen verwerpen en de externe versie gebruiken",
    "Reload" : "Herladen",
    ...
    "Click for options, hold to drag" : "Klik voor opties, houd vast om te slepen",
    ...
    "Close table of contents" : "Inhoudsopgave sluiten",
    "Pin table of contents" : "Inhoudsopgave vastzetten",
    ...
    "Alt" : "Alt",
    "Open link" : "Open link",
    "No link available to open" : "Geen link beschikbaar om te openen",
    "Cannot open links with unsafe protocols" : "Kan geen links met onveilige protocollen openen",
    "Edit link" : "Bewerk link",
    "Save changes" : "Wijzigingen opslaan",
    "Cancel" : "Annuleren",
    "URL" : "URL",
    "Edit block formula" : "Blokformule bewerken",
    "Edit inline formula" : "Inline-formule bewerken",
    "LaTeX formula" : "LaTeX-formule",
    "Save" : "Opslaan",
    ...
    "Diagram" : "Diagram",
    "Both" : "Beide",
    "Mermaid documentation" : "Mermaid-documentatie",
    ...
    "Option" : "Optie",
    "Formatting" : "Opmaak",
    "Start writing or type '/' to add…" : "Begin met typen of type '/' om toe te voegen…",
    ...
    "A table was pasted into a table. Nested tables are not supported." : "Een tabel is in een tabel geplakt. Geneste tabellen worden niet ondersteund.",
