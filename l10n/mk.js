OC.L10N.register(
    ...
    "_%n char_::_%n chars_" : ["%n карактер","%n карактери"],
    ...
    "Insert attachment" : "Вметни прилог",
    "Command" : "Команда",
    "Ctrl" : "Ctrl",
    "Option" : "Опции",
    "Formatting" : "Форматирање",
    "Start writing or type '/' to add…" : "Започни да пишуваш или напиши '/' за да додадеш...",
    ...
    "Created \"{name}\"" : "Креирана \"{name}\"",
    "Copied to the clipboard" : "Копирано во клипборд",
    "Could not copy to the clipboard" : "Неможе да се копира во клипборд.",
