OC.L10N.register(
    ...
    "This document is read-only." : "Is doiciméad inléite amháin é seo.Is doiciméad inléite amháin é seo.",
    "Read-only permission cannot save document changes. Please reload the page." : "Ní féidir le cead léite amháin athruithe ar dhoiciméid a shábháil. Athlódáil an leathanach le do thoil.",
    "Readme" : "Léim",
    "Text" : "Téacs",
    ...
    "Your editing permissions have been revoked. The document is now read-only." : "Tá do cheadanna eagarthóireachta curtha ar ceal. Is féidir an doiciméad a léamh amháin anois.",
    "You now have edit permissions for this document." : "Tá ceadanna eagarthóireachta agat anois don doiciméad seo.",
    "Keep my local changes and overwrite the remote version" : "Coinnigh mo chuid athruithe áitiúla agus scríobh thar an leagan cianda",
    "Discard my local changes and use the remote version" : "Scrios mo chuid athruithe áitiúla agus bain úsáid as an leagan cianda",
    "Comments" : "Tuairimí",
    "Previous comment" : "Trácht roimhe seo",
    "Next comment" : "An chéad trácht eile",
    "Close" : "Dún",
    "Guest" : "Aoi",
    "guest" : "aoi",
    "Edit" : "Cuir in eagar",
    ...
    "Save" : "Sábháil",
    "Cancel" : "Cealaigh",
    "Enter your name to comment" : "Cuir isteach d'ainm le trácht a dhéanamh",
    "Add a comment…" : "Cuir trácht leis…",
    "Comment" : "Trácht",
    "Reply" : "Freagra",
    "Front matter changed" : "Athraíodh ábhar tosaigh",
    "Image changed" : "Athraíodh an íomhá",
    "Mention changed" : "Athraíodh an trácht",
    "Mathematics changed" : "Athraíodh an mhatamaitic",
    "Footnote changed" : "Athraíodh an nóta coise",
    "Divider changed" : "Athraíodh an roinnteoir",
    "Changed content" : "Ábhar athraithe",
    "Paragraph" : "Paragraf",
    "Heading" : "Ceannteideal",
    "List item" : "Mír liosta",
    "Task" : "Tasc",
    "Table" : "Tábla",
    "Table row" : "Ró tábla",
    "Table cell" : "Cill tábla",
    "Image" : "Íomhá",
    "Code block" : "Bloc cód",
    "Quote" : "Athfhriotail",
    "Callout" : "Glao amach",
    "Details" : "Sonraí",
    "Footnote" : "Nóta coise",
    "Footnote reference" : "Tagairt nóta coise",
    "Front matter" : "Ábhar tosaigh",
    "Mathematics" : "Matamaitic",
    "Mention" : "Luaigh",
    "Link preview" : "Réamhamharc ar an nasc",
    "Added" : "Curtha leis",
    "Removed" : "Bhaint",
    "Changed" : "Athraithe",
    "Moved" : "Bogtha",
    "Content added" : "Ábhar curtha leis",
    "Content removed" : "Ábhar bainte",
    "Content changed" : "Ábhar athraithe",
    "No content" : "Gan aon ábhar",
    "Block-level" : "Leibhéal bloc",
    "Moved section" : "Roinn bogtha",
    "Structure changed" : "Athraíodh an struchtúr",
    "{context} added" : "{context} curtha leis",
    "{context} removed" : "Baineadh {context}",
    "{context} changed" : "athraíodh {context}",
    "Table column added" : "Colún tábla curtha leis",
    "Table column removed" : "Baineadh an colún tábla",
    "Table column changed" : "Athraíodh colún an tábla",
    "Section: {section}" : "Roinn: {section}",
    "Change pages" : "Athraigh leathanaigh",
    "Previous" : "Roimhe Seo",
    "Showing changes {from}–{to} of {total}" : "Ag taispeáint athruithe {from}–{to} de {total}",
    "Next" : "Ar aghaidh",
    "Document start" : "Tús an doiciméid",
    "Block-level change; fine inline detail is unavailable" : "Athrú ar leibhéal an bhloic; níl mionsonraí míne inlíne ar fáil",
    "_%n change_::_%n changes_" : ["%n athrú","%n athruithe","%n athruithe","%n athruithe","%n athruithe"],
    "_%n edit_::_%n edits_" : ["%n eagarthóireacht","%n eagarthóireacht","%n eagarthóireacht","%n eagarthóireacht","%n eagarthóireacht"],
    "Reload" : "Athlódáil",
    ...
    "No link available to open" : "Níl aon nasc ar fáil le hoscailt",
    ...
    "Markdown source" : "Foinse Markdown",
    "Before" : "Roimh",
    "After" : "Tar éis",
    "Before document" : "Roimh an doiciméad",
    "After document" : "Tar éis an doiciméid",
    "Detailed rendered comparison unavailable" : "Níl comparáid mhionsonraithe rindreáilte ar fáil",
    "Change {current} of {total}: {label}" : "Athraigh {current} de {total}: {label}",
    "No rendered changes" : "Gan aon athruithe rindreáilte",
    "Version comparison" : "Comparáid leaganacha",
    "Comparison view" : "Radharc comparáide",
    "Change navigation" : "Athraigh an nascleanúint",
    "Previous change" : "Athrú roimhe seo",
    "Next change" : "An chéad athrú eile",
    "Hide formatting-only changes" : "Folaigh athruithe formáidithe amháin",
    "{count} hidden" : "{count} i bhfolach",
    "Show" : "Taispeáin",
    "All rendered changes are formatting-only and hidden by the current filter." : "Is formáidiú amháin atá sna hathruithe uile a dhéantar agus tá siad i bhfolach ag an scagaire reatha.",
    "No rendered differences — Markdown syntax differs." : "Gan aon difríochtaí rindreáilte — Tá difríocht idir comhréir an Mhargaidh.",
    "Open Markdown source" : "Foinse Oscailte Markdown",
    "No differences." : "Gan aon difríochtaí.",
    "Version to display" : "Leagan le taispeáint",
    "Source compares literal Markdown, so its change groups can differ from rendered changes." : "Déanann an fhoinse comparáid idir Markdown liteartha, mar sin is féidir go mbeidh a ghrúpaí athraithe difriúil ó na hathruithe rindreáilte.",
    "removed" : "bainte",
    "{count} trailing spaces" : "{count} spásanna deiridh",
    "No newline at end of file" : "Gan aon líne nua ag deireadh an chomhaid",
    "Markdown source comparison" : "Comparáid foinse Markdown",
    "Loading Markdown source differences…" : "Ag lódáil difríochtaí foinse Markdown…",
    "Could not load Markdown source differences." : "Níorbh fhéidir difríochtaí foinse Markdown a luchtú.",
    "Retry" : "Bain triail eile as",
    "Detailed source differences exceeded the safe processing limit." : "Sháraigh difríochtaí foinse mionsonraithe an teorainn phróiseála sábháilte.",
    "Line endings changed: {before} → {after}" : "Athraíodh deireadh línte: {before} → {after}",
    "Source change {current} of {total}" : "Athrú foinse {current} de {total}",
    "Source version to display" : "Leagan foinse le taispeáint",
    "Hide unchanged lines" : "Folaigh línte gan athrú",
    "Show {count} unchanged lines" : "Taispeáin {count} línte gan athrú",
    "Show more unchanged lines" : "Taispeáin níos mó línte gan athrú",
    "Additional unchanged lines are hidden to keep the comparison responsive." : "Tá línte breise gan athrú i bhfolach chun an chomparáid a choinneáil freagrúil.",
    "Lines {before} / {after}" : "Línte {before} / {after}",
    "Complete Markdown source" : "Foinse iomlán Markdown",
    "Complete Markdown source is shown because a detailed comparison is unavailable." : "Taispeántar foinse iomlán Markdown mar nach bhfuil comparáid mhionsonraithe ar fáil.",
    "Source preview was truncated to the display limit." : "Gearradh réamhamharc an fhoinse go dtí an teorainn taispeána.",
    ...
    "Open attachment {name}" : "Oscail an ceangaltán {name}",
    "Delete this attachment" : "Scrios an ceangaltán seo",
    "Open image {name}" : "Oscail íomhá {name}",
    ...
    "Image description changed" : "Cur síos ar an íomhá athraithe",
    "Link target changed" : "Athraíodh sprioc an naisc",
    "Link changed" : "Nasc athraithe",
    "Link preview changed" : "Athraíodh réamhamharc naisc",
    "Task state changed" : "Athraíodh staid an tasc",
    "Heading level changed" : "Athraíodh leibhéal an cheannteidil",
    "List start changed" : "Athraíodh tús an liosta",
    "Code language changed" : "Athraíodh teanga an chóid",
    "Text direction changed" : "Athraíodh treo an téacs",
    "Table structure changed" : "Athraíodh struchtúr an tábla",
    "Table alignment changed" : "Athraíodh ailíniú an tábla",
    "Callout type changed" : "Athraíodh cineál glaonna amach",
    "Details state changed" : "Athraíodh staid na sonraí",
    "Attribute changed" : "Athraíodh an tréith",
    "Inline code" : "Cód inlíne",
    "{formatting} changed" : "athraíodh {formatting}",
    ...
    "Show annotations" : "Taispeáin anótálacha",
    "Hide annotations" : "Folaigh anótálacha",
