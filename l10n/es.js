OC.L10N.register(
    ...
    "The file was only partially uploaded" : "El archivo ha sido subido solo parcialmente",
    ...
    "Overwrite the file and save the current changes" : "Sobrescribir el archivo y guardar los cambios actuales",
    "Discard the current changes and load the latest version" : "Descartar los cambios actuales y cargar la última versión",
    "Reload" : "Recargar",
    "The file was overwritten. Your current changes cannot be auto-saved. Please choose how to proceed." : "El archivo fue sobrescrito. Sus cambios actuales no pueden ser guardados automáticamente. Por favor, escoja como proceder.",
    "The document could not be loaded. Please check your internet connection." : "El documento no pudo ser cargado. Por favor, chequee su conexión a internet.",
    "Reconnect" : "Reconectar",
    "You've been disconnected from the server." : "Ha sido desconectado del servidor.",
    "This file is opened read-only as it is currently locked by {user}." : "Este archivo se ha abierto como de solo lectura pues está actualmente bloqueado por el usuario {user}.",
    "Close outline view" : "Cerrar vista de esquema",
    "Outline" : "Esquema",
    "Not connected. Cannot update guest name." : "No está conectado. No se puede actualizar el nombre del invitado.",
    "Failed to update the guest name." : "Fallo al actualizar el nombre del invitado.",
    "Enter your name so other people can see who is editing" : "Introduzca su nombre para que otras personas puedan ver quién está editando",
    "Enter your name" : "Escriba su nombre",
    "Guest" : "Invitado",
    "submit" : "enviar",
    "you" : "usted",
    "edit" : "editar",
    "Uploading multiple attachments failed." : "La subida de múltiples adjuntos ha fallado.",
    "Uploading attachment failed: {error}" : "La subida del adjunto ha fallado: {error}",
    "Uploading attachment failed." : "La subida del adjunto ha fallado.",
    "Insert an attachment" : "Insertar un adjunto",
    "Failed to insert from Files" : "Fallo al insertar desde Archivos",
    "Failed to create attachment" : "Fallo al crear adjunto",
    "Offline since {time}." : "Fuera de línea desde {time}",
    "Not connected to the cloud." : "No está conectado a la nube.",
    "Preview options" : "Opciones de vista previa",
    "Text only" : "Solo texto",
    "Show link preview" : "Mostrar vista previa del enlace",
    ...
    "Offline, changes will be saved when online" : "Sin conexión, se guardarán los cambios una vez esté en línea",
    "Saving …" : "Guardando …",
    "Saved" : "Guardado",
    ...
    "Speed up your writing with simple shortcuts." : "Mejore su velocidad de escritura con atajos de teclado sencillos.",
    "Just type the Markdown syntax or use keyboard shortcuts from below." : "Simplemente escriba usando sintaxis Markdown o use los atajos de teclado que se muestran más abajo.",
    "Just type the Markdown syntax from below." : "Simplemente escriba usando sintaxis Markdown que se muestra más abajo.",
    "Style" : "Estilo",
    "Syntax" : "Sintaxis",
    ...
    "Alt" : "Alt",
    "Cannot copy, please copy the link manually" : "No se ha podido copiar, por favor, copie el enlace manualmente",
    ...
    "Cancel" : "Cancelar",
    "URL" : "URL",
    "Disabled because you are currently offline." : "Deshabilitado ya que se encuentra sin conexión.",
    "Attachments cannot be created or uploaded because this file is shared from another cloud." : "Los adjuntos no pueden ser creados o subidos ya que este archivo está compartido desde otra nube.",
    ...
    "Full width editor" : "Editor a anchura completa",
    ...
    "Uploading attachments is disabled because the file is shared from another cloud." : "La subida de adjuntos está deshabilitada ya que el archivo está compartido desde otra nube.",
    "Upload" : "Subir",
    ...
    "Warning callout" : "Nota de advertencia",
    ...
    "Warning" : "Advertencia",
    "Danger" : "Peligro",
    "Start writing, or try '/' to add, '@' to mention…" : "Comience a escribir, o pruebe '/' para añadir, '@' para mencionar…"
},
