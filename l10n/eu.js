OC.L10N.register(
    ...
    "Overwrite the file and save the current changes" : "Gainidatzi fitxategia eta gorde uneko aldaketak",
    "Discard the current changes and load the latest version" : "Baztertu uneko aldaketak eta kargatu azken bertsioa",
    "Reload" : "Birkargatu",
    "The file was overwritten. Your current changes cannot be auto-saved. Please choose how to proceed." : "Fitxategia gainidatzi da. Zure uneko aldaketak ezin izan dira automatikoki gorde. Aukeratu zer egin.",
    "The document could not be loaded. Please check your internet connection." : "Dokumentua ezin izan da kargatu. Aztertu zure internet konexioa.",
    "Reconnect" : "Berriro konektatu",
    "You've been disconnected from the server." : "Zerbitzaritik deskonektatuta zaude.",
    ...
    "Insert below" : "Txertatu behean",
    "Click for options, hold to drag" : "Egin klik aukerak ikusteko, eduki sakatuta arrastatzeko",
    "Not connected. Cannot update guest name." : "Konexiorik gabe. Ezin da gonbidatuaren izena eguneratu.",
    "Failed to update the guest name." : "Huts egin du gonbidatuaren izena eguneratzean.",
    ...
    "Failed to create attachment" : "Ezin izan da eranskina sortu",
    "Offline since {time}." : "Lineaz kanpo {time} unetik.",
    "Not connected to the cloud." : "Hodeira konektatu gabe.",
    ...
    "Close table of contents" : "Itxi aurkibidea",
    "Pin table of contents" : "Ainguratu aurkibidea",
    ...
    "Cancel" : "Utzi",
    "URL" : "URLa",
    "Edit block formula" : "Editatu bloke formula",
    "Edit inline formula" : "Editatu lineako formula",
    "LaTeX formula" : "LaTeX formula",
    "Save" : "Gorde",
    "Disabled because you are currently offline." : "Desaktibatu da une honetan lineaz kanpo zaudelako.",
    "Attachments cannot be created or uploaded because this file is shared from another cloud." : "Eranskinak ezin izan dira sortu edo kargatu fitxategia beste hodei batetik partekatu delako.",
    ...
    "Uploading attachments is disabled because the file is shared from another cloud." : "Eranskinak kargatzea desaktibatuta dago fitxategia beste hodei batetik partekatu delako.",
    "Upload" : "Igo",
    ...
    "Blocks" : "Blokeak",
    "Inline math" : "Lineako matematika",
    "Block math" : "Bloke matematika",
    ...
    "Option" : "Aukera",
    "Formatting" : "Formatua",
    "Start writing or type '/' to add…" : "Hasi idazten edo sakatu \"/\" gehitzeko...",
