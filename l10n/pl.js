OC.L10N.register(
    ...
    "Keep my local changes and overwrite the remote version" : "Zachowaj moje lokalne zmiany i nadpisz wersję zdalną",
    "Discard my local changes and use the remote version" : "Odrzuć moje lokalne zmiany i użyj wersji zdalnej",
    "Reload" : "Przeładuj",
    ...
    "Click for options, hold to drag" : "Kliknij, aby wyświetlić opcje, przytrzymaj, aby przeciągnąć",
    "Not connected. Cannot update guest name." : "Nie połączono. Nie można zaktualizować nazwy gościa.",
    "Failed to update the guest name." : "Nieudana próba aktualizacji nazwy gościa.",
    ...
    "Offline since {time}." : "Jest offline od {time}.",
    "Not connected to the cloud." : "Brak połączenia z chmurą.",
    ...
    "Close table of contents" : "Zamknij spis treści",
    "Pin table of contents" : "Przypnij spis treści",
    ...
    "Cancel" : "Anuluj",
    "URL" : "Adres URL",
    "Edit block formula" : "Edytuj formułę blokową",
    "Edit inline formula" : "Edytuj formułę w tekście",
    "LaTeX formula" : "Formuła LaTeX",
    "Save" : "Zapisz",
    "Disabled because you are currently offline." : "Wyłączone ponieważ jesteś obecnie offline.",
    ...
    "Blocks" : "Bloki",
    "Inline math" : "Matematyka w tekście",
    "Block math" : "Matematyka blokowa",
    ...
    "Start writing or type '/' to add…" : "Zacznij pisać lub wpisz '/', aby dodać…",
    ...
    "Front matter" : "Wstęp",
    "A table was pasted into a table. Nested tables are not supported." : "Tabela została wklejona do tabeli. Zagnieżdżone tabele nie są obsługiwane.",
