OC.L10N.register(
    ...
    "Comment" : "Commentaire",
    "Reply" : "Répondre",
    "Front matter changed" : "Avant-propos modifié",
    "Image changed" : "Image modifiée",
    "Mention changed" : "Mention modifiée",
    "Mathematics changed" : "Mathématiques changées",
    "Footnote changed" : "Note de bas de page modifiée",
    "Divider changed" : "Séparateur changé",
    "Changed content" : "Contenu changé",
    ...
    "{context} added" : "{context} ajouté",
    "{context} removed" : "{context} supprimé",
    "{context} changed" : "{context} modifié",
    ...
    "Block-level change; fine inline detail is unavailable" : "Changement au niveau du bloc ; le détail précis en ligne n'est pas disponible",
    ...
    "Change navigation" : "Navigation entre les changements",
    "Previous change" : "Modification précédente",
    "Next change" : "Modification suivante",
    "Hide formatting-only changes" : "Masquer les modifications de formatage",
    "{count} hidden" : "{count} masquées",
    "Show" : "Afficher les images",
    "All rendered changes are formatting-only and hidden by the current filter." : "Toutes les modifications de rendu ne concernent que le formatage et sont masquées par le filtre actuel.",
    ...
    "Source compares literal Markdown, so its change groups can differ from rendered changes." : "La source compare le Markdown littéral ; ses groupes de changements peuvent donc différer des changements rendus.",
    "removed" : "supprimé",
    "{count} trailing spaces" : "{count} espaces de fin",
    ...
    "Loading Markdown source differences…" : "Chargement des différences de sources Markdown…",
    ...
    "Line endings changed: {before} → {after}" : "Fins de lignes modifiées : {before} → {after}",
    ...
    "Show {count} unchanged lines" : "Afficher {count} lignes inchangées",
    "Show more unchanged lines" : "Afficher plus de lignes inchangées",
    "Additional unchanged lines are hidden to keep the comparison responsive." : "Les lignes supplémentaires non modifiées sont cachées pour conserver la réactivité de la comparaison.",
    "Lines {before} / {after}" : "Lignes {before} / {after}",
    "Complete Markdown source" : "Source Markdown complet",
    "Complete Markdown source is shown because a detailed comparison is unavailable." : "Le source Markdown complet est affiché car il n'y a pas de comparaison détaillée disponible.",
    ...
    "Link target changed" : "Cible de lien modifié",
    "Link changed" : "Lien modifié",
    "Link preview changed" : "Aperçu du lien changé",
    "Task state changed" : "État de la tâche changé",
    "Heading level changed" : "Niveau de titre modifié",
    "List start changed" : "Début de liste changé",
    "Code language changed" : "Langage de code changé",
    "Text direction changed" : "Direction du texte modifiée",
    "Table structure changed" : "Structure de tableau modifiée",
    "Table alignment changed" : "Alignement de tableau modifié",
    "Callout type changed" : "Type d'encadré changé",
    "Details state changed" : "État du bloc Détails changé",
    "Attribute changed" : "Attribut modifié",
    "Inline code" : "Code inséré",
    "{formatting} changed" : "{formatting} modifié",
