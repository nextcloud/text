OC.L10N.register(
    ...
    "Close table of contents" : "Κλείσιμο πίνακα περιεχομένων",
    "Pin table of contents" : "Καρφίτσωμα πίνακα περιεχομένων",
    ...
    "Blocks" : "Μπλοκ",
    "Inline math" : "Μαθηματικά εντός γραμμής",
    "Block math" : "Μαθηματικά σε πλαίσιο",
    ...
    "Start writing or type '/' to add…" : "Ξεκινήστε την πληκτρολόγηση ή πληκτρολογήστε '/' για προσθήκη…",
