OC.L10N.register(
    ...
    "Document has been changed outside of the editor. The changes cannot be applied" : "Skjalinu hefur verið breytt utan ritilsins. Ekki var hægt að framkvæma breytingarnar",
    "Document could not be loaded. Please check your internet connection." : "Ekki var hægt að hlaða inn skjalinu. Athugaðu nettenginguna þína.",
    ...
    "Warning" : "Aðvörun",
    "Danger" : "Hættulegt",
    "Start writing, or try '/' to add, '@' to mention…" : "Byrja að skrifa eða prófaðu'/' til að bæta við, '@' til að minnast á…"
},
