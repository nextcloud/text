OC.L10N.register(
    ...
    "This document is read-only." : "このドキュメントは読み取り専用です。",
    "Read-only permission cannot save document changes. Please reload the page." : "読み取り専用権限では、ドキュメントの変更を保存できません。ページを再読み込みしてください。",
    "Readme" : "Readme",
    "Text" : "テキスト",
    ...
    "Keep my local changes and overwrite the remote version" : "ローカルでの変更を保持し、リモート版を上書きする",
    "Discard my local changes and use the remote version" : "ローカルの変更を破棄し、リモートのバージョンを使用する",
    "Reload" : "再読み込み",
    ...
    "Your editing permissions have been revoked. The document is now read-only." : "編集権限が取り消されました。このドキュメントは現在、読み取り専用となっています。",
    "You now have edit permissions for this document." : "このドキュメントの編集権限が与えられました。",
    ...
    "Alt" : "Alt",
    "Open link" : "リンクを開く",
    "No link available to open" : "開くためのリンクがありません",
    "Cannot open links with unsafe protocols" : "安全でないプロトコルを使用しているリンクは開けません",
    "Edit link" : "リンクを編集",
    "Save changes" : "変更を保存",
    "Cancel" : "キャンセル",
    "URL" : "URL",
    ...
    "Sort ascending" : "昇順で整列",
    "Sort descending" : "降順で整列",
