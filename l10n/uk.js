OC.L10N.register(
    ...
    "This document is read-only." : "Документ тільки для читання.",
    "Read-only permission cannot save document changes. Please reload the page." : "Повноваження лише для читання не дозволяють зберегти документи. Перезавантажте сторінку.",
    "Readme" : "Readme",
    "Text" : "Текст",
    ...
    "Your editing permissions have been revoked. The document is now read-only." : "Ваші повноваження на редагування було відкликано. Відтепер документ лише для читання.",
    "You now have edit permissions for this document." : "Ви маєте повноваження на редагування цього документа.",
    "Keep my local changes and overwrite the remote version" : "Зберегти мої зміни на пристрої та перезаписати віддалену версію ",
    "Discard my local changes and use the remote version" : "Відхилити зміни, які було зроблено на пристрої, та використовувати віддалену версію ",
    "Comments" : "Коментарі",
    "Previous comment" : "Попередній коментар",
    "Next comment" : "Наступний коментар",
    "Close" : "Закрити",
    "Guest" : "Гість",
    "guest" : "гість",
    "Edit" : "Редагувати",
    ...
    "Save" : "Зберегти",
    "Cancel" : "Скасувати",
    "Enter your name to comment" : "Зазначте ваше ім'я, щоб залишити коментар",
    ...
    "You've been disconnected from the server." : "Вас будо від'єднано від сервера.",
    ...
    "Offline since {time}." : "Поза мережею від {time}.",
    "Not connected to the cloud." : "Відсутнє з'єднання з хмарою.",
    ...
    "Close table of contents" : "Закрити зміст",
    "Pin table of contents" : "Закріпити зміст",
    ...
    "Just type the Markdown syntax or use keyboard shortcuts from below." : "Просто введіть синтаксис Markdown або скористайтеся нижче наведеними клавіатурними скороченнями.",
    ...
    "Edit block formula" : "Редагувати формулу в блоці",
    "Edit inline formula" : "Редагувати формулу в тексті",
    "LaTeX formula" : "Формула LaTeX",
    ...
    "Uploading attachments is disabled because the file is shared from another cloud." : "Завантаження вкладень вимкнено, оскільки цим файлом поділилився користувач іншої хмари.",
    "Upload" : "Завантажити",
    "Insert Table" : "Додати таблицю",
    "Smart Picker" : "Асистент вибору",
    ...
    "Blocks" : "Блоки",
    "Inline math" : "Рівняння в тексті",
    "Block math" : "Рівняння в блоці",
    ...
    "Question callout" : "Виноска",
    "Annotations" : "Анотації",
    "Show annotations" : "Показувати анотації",
    ...
    "Link a file" : "Додати посилання на файл",
    "Start writing or type '/' to add…" : "Почніть писати або введіть '/', щоб додати...",
    ...
    "Could not copy to the clipboard" : "Не вдалося скопіювати до буфера обміну",
