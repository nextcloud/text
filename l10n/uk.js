OC.L10N.register(
    ...
    "Show folder description" : "Показати опис каталогу",
    ...
    "No permission to access this file." : "Відсутній дозвіл на доступ до цього файлу.",
    "Pick plain text files" : "Вибрати текстові файли без розмітки",
