OC.L10N.register(
    ...
    "Keep my local changes and overwrite the remote version" : "Сохранить мои локальные изменения и перезаписать удалённую версию",
    "Discard my local changes and use the remote version" : "Отменить мои локальные изменения и использовать удалённую версию",
    "Reload" : "Обновить",
    ...
    "Click for options, hold to drag" : "Нажмите, чтобы просмотреть параметры, удерживайте, чтобы перетащить",
    ...
    "Close table of contents" : "Закрыть оглавление",
    "Pin table of contents" : "Закрепить оглавление",
    "Table of contents" : "Оглавление",
    "Your editing permissions have been revoked. The document is now read-only." : "Ваши права на редактирование были отозваны. Теперь документ доступен только для чтения.",
    "You now have edit permissions for this document." : "Теперь у вас есть права на редактирование этого документа.",
    ...
    "Highlight" : "Цветовыделить",
    "Highlighted text" : "Цветовыделенный текст",
    ...
    "No link available to open" : "Нет ссылки для открытия",
    "Cannot open links with unsafe protocols" : "Невозможно открыть ссылки с небезопасными протоколами",
    "Edit link" : "Редактировать ссылку",
    "Save changes" : "Сохранить изменения",
    "Cancel" : "Отмена",
    "URL" : "URL",
    "Edit block formula" : "Редактировать блок формулы",
    "Edit inline formula" : "Редактировать встроенную формулу",
    "LaTeX formula" : "LaTeX формула",
    "Save" : "Сохранить",
    ...
    "Block math" : "Математический блок",
    ...
    "Start writing or type '/' to add…" : "Начните печатать или введите '/', чтобы добавить…",
    ...
    "A table was pasted into a table. Nested tables are not supported." : "Таблица вставлена в таблицу. Вложенные таблицы не поддерживаются.",
