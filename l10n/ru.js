OC.L10N.register(
    ...
    "Open link picker" : "Открыть диалог создания ссылки",
    ...
    "Image file format not supported" : "Формат файла изображения не поддерживается",
    ...
    "Document save status" : "Состояние сохранения документа"
},
