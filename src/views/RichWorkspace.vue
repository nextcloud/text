...
const defaultExtension = loadState('text', 'default_file_extension')
const descriptionFile = 'Readme.' + defaultExtension
const translatedDescriptionFile = t('text', 'Readme') + '.' + defaultExtension
