...
describe('wiki image links (markdown-it)', () => {
	it('renders a standalone wiki image as a figure', () => {
		expect(markdownit.render('![[Pasted image.png]]')).to.equal('<figure><img src="Pasted image.png" alt="Pasted image.png" data-wiki-image="true" /></figure>\n')
	})

	it('renders an inline wiki image inside a paragraph', () => {
		expect(markdownit.render('text ![[test.png]] more text')).to.equal('<p>text <img src="test.png" alt="test.png" data-wiki-image="true" /> more text</p>\n')
	})

	it('renders a wiki image after a paragraph', () => {
		expect(markdownit.render('Hello\n\n![[test.png]]')).to.equal('<p>Hello</p>\n<figure><img src="test.png" alt="test.png" data-wiki-image="true" /></figure>\n')
	})
...
describe('wiki text links (markdown-it)', () => {
	it('renders a simple wiki link', () => {
		expect(markdownit.render('[[WikiLink]]')).to.equal('<p><a href="WikiLink" data-wiki-link="true">WikiLink</a></p>\n')
	})

	it('renders a wiki link with display text', () => {
		expect(markdownit.render('[[Target|Display Text]]')).to.equal('<p><a href="Target" data-wiki-link="true">Display Text</a></p>\n')
	})
