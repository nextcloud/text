  ...
  methods: {
    toggle: function toggle() {
      ...
      if (this.showWorkspace) {
        (0, _eventBus.emit)('Text::showRichWorkspace');

        _axios.default.post((0, _router.generateUrl)('/apps/text/settings'), {
          key: 'workspace_enabled',
          value: '1'
        });
      } else {
        (0, _eventBus.emit)('Text::hideRichWorkspace');
...
var _FilesSettings = _interopRequireDefault(__webpack_require__(/*! ./views/FilesSettings */ "./src/views/FilesSettings.vue"));
...
__webpack_require__.p = (0, _router.linkTo)('text', 'js/'); // eslint-disable-line

var workspaceAvailable = (0, _initialState.loadState)('text', 'workspace_available');
var workspaceEnabled = (0, _initialState.loadState)('text', 'workspace_enabled');
document.addEventListener('DOMContentLoaded', function () {
  if (typeof OCA.Viewer === 'undefined') {
    console.error('Viewer app is not installed');
    (0, _files.registerFileActionFallback)();
  }

  if (workspaceAvailable && OCA && OCA.Files && OCA.Files.Settings) {
    _vue.default.prototype.t = window.t;
    _vue.default.prototype.n = window.n;
    _vue.default.prototype.OCA = window.OCA;
    var vm = new _vue.default({
      render: function render(h) {
        return h(_FilesSettings.default, {});
      },
...
if (workspaceAvailable) {
  OC.Plugins.register('OCA.Files.FileList', _files.FilesWorkspacePlugin);
}
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
